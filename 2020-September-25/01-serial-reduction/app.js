...
// reduction 
// .......................................................................
var reductionResult = new Abubu.Float32Texture(1,1) ;

var reduce = new Abubu.Solver({
    fragmentShader : source( 'reduce' ) ,
    uniforms : { 
        inTexture : { type : 't', value : fcolor } ,
    } ,
    targets : { 
        ocolor : { location : 0, target : reductionResult } ,
    }
} ) ;
...
rplot.addMessage(
    'Overal activation', 0.5,0.05,{
        font : 'Bold 14pt Arial' ,
        align: 'center',
        style: "#ff0000" ,
    } ) ;

env.rsgn = rplot.addSignal( reductionResult, {
    channel : 'r',
    minValue : -0.,
    maxValue : 1. ,
    restValue : 0 ,
